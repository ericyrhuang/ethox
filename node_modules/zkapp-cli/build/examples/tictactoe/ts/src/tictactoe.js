...
import { Field, State, PublicKey, SmartContract, state, method, Bool, Provable, Signature, Struct, } from 'o1js';
    ...
    update(x, y, playerToken) {
        for (let i = 0; i < 3; i++) {
            for (let j = 0; j < 3; j++) {
                ...
                this.board[i][j] = Provable.if(toUpdate, new OptionalBool(true, playerToken), this.board[i][j]);
            }
        }
    }
    printState() {
...
class TicTacToe extends SmartContract {
    ...
    // 1 | x  x  x
    // 2 | x  x  x
    async play(pubkey, signature, x, y) {
...
__decorate([
    state(Bool),
    __metadata("design:type", Object)
], TicTacToe.prototype, "nextIsPlayer2", void 0);
__decorate([
    state(Bool),
    __metadata("design:type", Object)
], TicTacToe.prototype, "gameDone", void 0);
__decorate([
    state(PublicKey),
    __metadata("design:type", Object)
], TicTacToe.prototype, "player1", void 0);
__decorate([
    state(PublicKey),
    __metadata("design:type", Object)
], TicTacToe.prototype, "player2", void 0);
__decorate([
    method,
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [PublicKey, PublicKey]),
    __metadata("design:returntype", Promise)
], TicTacToe.prototype, "startGame", null);
__decorate([
    method,
    __metadata("design:type", Function),
